    ...
    return (
        <div className="text-[8px] lg:text-sm space-y-1 lg:space-y-4">
            <div className=" flex justify-between">
                ...
                <div className="">
                    ...
                    <div className=" flex justify-center gap-1 items-center">
                        ...
                        <p className=' font-semibold text-[10px] lg:text-md'>1</p>
                    </div>
                </div>
            </div>
            ...
            <div className=" flex justify-center">
                ...
                <div className="border-l-2 border-white/10 lg:mx-10 lg:self-stretch"></div>
                <div className="">
                    <p>Sell Tax</p>
                    <div className=" flex justify-center gap-1 items-center">
                        <img className='h-2 lg:h-4' src={Assets.Shield} alt="" />
                ...
                <div className="border-l-2 border-white/10 mx-6 lg:mx-10 lg:self-stretch"></div>
                <div className="">
                    <p>Transfer Tax</p>
                    <div className=" flex justify-center gap-1 items-center">
                        <img className='h-2 lg:h-4' src={Assets.Shield} alt="" />
